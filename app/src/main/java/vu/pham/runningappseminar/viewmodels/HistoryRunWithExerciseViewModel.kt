...
class HistoryRunWithExerciseViewModel(private val mainRepository: MainRepository) : ViewModel() {

    private val runSortedByDate = mainRepository.getAllRunsWithExerciseSortedByDate()
    private val runSortedByTimeInMillies = mainRepository.getAllRunsWithExerciseSortedByTimeInMillies()
    private val runSortedByAvgSpeedInKMH = mainRepository.getAllRunsWithExerciseSortedByAvgSpeedInKMH()
    private val runSortedByCaloriesBurned = mainRepository.getAllRunsWithExerciseSortedByCaloriesBurned()
    private val runSortedByDistance = mainRepository.getAllRunsWithExerciseSortedByDistance()
